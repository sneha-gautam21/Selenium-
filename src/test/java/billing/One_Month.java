...
public class One_Month {
	    ...
	    public static void main(String[] args) throws InterruptedException {
	        ...
	        // Initialize counters for total DL60 classes, students, and trial students for the entire month
	        int totalDL60Count = 0;
	        int totalStudentCount = 0;
	        int totalTrialStudentCount = 0;

	        // Iterate through the next 30 days (1 month)
	        for (int i = 1; i <= 30; i++) {
	            ...
	            // Count the total number of DL60 classes for the entire month
	            ...
	            for (WebElement classElement : classElements) {
	                ...
	                // Accumulate the student count to the total for the entire month
	                ...
	                // Accumulate the trial student count to the total for the entire month
	        ...
	        // After looping through all days, print the total counts for the entire month
