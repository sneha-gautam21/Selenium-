...
public class Active_students {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Map to store student names and their occurrence count for the entire week
        ...
        // Print the student count results for the entire week
        System.out.println("\nStudent Occurrences over the week:");
        for (Map.Entry<String, Integer> entry : studentCountMap.entrySet()) {
            System.out.println(entry.getKey() + ": " + entry.getValue());
        }

        // Print total and unique student counts for the week
